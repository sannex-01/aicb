      ...
      <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start">
          ...
          <nav class="w-full md:w-60 flex-shrink-0 flex flex-row md:flex-col gap-1 p-1.5 bg-surface rounded-xl border border-subtle">
            ${tabs.map(t => `
              <button class="settings-tab flex items-center gap-2.5 px-3.5 py-2.5 rounded-lg text-[14px] font-medium text-left transition-colors ${activeTab === t.id ? 'bg-surface-hover text-main' : 'text-muted hover:bg-surface-hover hover:text-main'}" data-tab="${t.id}">
